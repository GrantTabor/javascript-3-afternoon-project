...
function largeNumbers({first, second, third}){
  let smallestNumber;
  first < second ? smallestNumber = first : smallestNumber = second;
  smallestNumber > third ? smallestNumber = third : smallestNumber = smallestNumber;
...
function numberGroups({a, b, c}){
  ...
  //a.length > b.length && c.length ? return a : 
}
